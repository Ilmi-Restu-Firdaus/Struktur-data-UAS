    ...
    public static void main(String[] args) {
        ...
        if (jenisbarang.equalsIgnoreCase("makanan") || jenisbarang.equalsIgnoreCase("minuman")) {
            ...
            System.out.println("Total Belanja                     : " + total);
             String riwayatMasuk = "[+] " +"jenis :" + jenisbarang + ",Nama :" + namabarang + ", Jumlah :" + jumlahbarang+", Harga :"+ hargabarang+", total belanja: "+ total+ " ditambahkan ke gudang.";
