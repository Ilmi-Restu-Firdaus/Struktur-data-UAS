    ...
    public static void main(String[] args) {
        ...
        if (jenisbarang.equalsIgnoreCase("makanan") || jenisbarang.equalsIgnoreCase("minuman")) {
           ...
           if(!tambahbarang.isEmpty()){
            ...
            if (item.Jumlah() > 0) {
                System.out.println("Jenis: " + item.Jenis() + ", Nama: " + item.Nama() + ", Jumlah: " + item.Jumlah() + ", harga: " + item.Harga() + ", Total pembelian: " + item.total());
                }
            }
                }else {
        ...
        for (tambah item : tambahbarang) {
         if (item.Jenis.equalsIgnoreCase(jenisKeluar) && item.Nama.equalsIgnoreCase(namaKeluar)) {
            ...
            if (jumlahKeluar <= item.Jumlah) {
                ...
                String riwayatKeluar = "[-] " + "Jenis : " + jenisKeluar + ", Nama: " + namaKeluar +", harga satuan: " + hargajual + ", Jumlah: "+ jumlahKeluar +", total penjualan: "+ totaljual;
